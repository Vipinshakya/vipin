...
let textcontainer=document.querySelector(".title-text")
let Imgcontainer=document.querySelector(".title-img")
...
for(let i=0; i<365; i++){
 ...
 window.addEventListener("scroll", ()=>{
    ...
    Imgcontainer.style.transform =`translateX(${-offsetY * 0.4}px , ${offsetY * 0.6}px)`
 })
